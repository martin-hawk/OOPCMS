			...
			<div class="col-lg-12">
				...
				<form action="" method="post">
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							<a href="" class="thumbnail"><img alt="" class="admin-photo-thumbnail" src="<?php echo $photo->picture_path(); ?>"></a>
						</div>
						<div class="form-group">
							<label for="caption">Caption</label> <input type="text"
								name="caption" class="form-control"
								value="<?php echo $photo->caption; ?>">
						</div>
						<div class="form-group">
							<label for="alt_text">Alternate text</label> <input type="text"
								name="alt_text" class="form-control"
								value="<?php echo $photo->alt_text; ?>">
						</div>
						<div class="form-group">
